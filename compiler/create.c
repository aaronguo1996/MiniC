...
TypeSpecifier *
minic_create_type_specifier(MINIC_BasicType basic_type)
{
	TypeSpecifier *type;
...
minic_create_class_type_specifier(char *identifier)
{
	...
	type = minic_alloc_type_specifier(MINIC_CLASS_TYPE);
...
Expression *
minic_create_boolean_expression(MINIC_Boolean value)
{
	Expression *exp;
...
Expression *
minic_create_basic_array_creation(MINIC_BasicType basic_type,
